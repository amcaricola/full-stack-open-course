...
describe('favorite blog', () => {
    test('favorite blog', () => {
        const result = listHelper.favoriteBlog(list_of_blogs);
...
describe('most blogs', () => {
    test('author with the most blogs', () => {
        const result = listHelper.mostBlogs(list_of_blogs);
...
describe('most likes', () => {
    test('author with the most likes', () => {
        const result = listHelper.mostLikes(list_of_blogs);
